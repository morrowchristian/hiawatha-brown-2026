...
export default function Nav() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-gray-700/90 py-3 shadow-lg">
            ...
            {navLinks.map(({ label, href, external }) =>
              external ? (
                ...
                >
                  ...
                  <span className="absolute left-0 -bottom-1 w-0 h-[2px] bg-[#e91e63] transition-all duration-300 group-hover:w-full" />
                </a>
              ) : (
                <Link
                  key={label}
