    ...
    <>
      <div className="h-screen flex flex-col bg-[#EEF1F5] overflow-hidden">
        ...
        >
          ...
          <button
            onClick={() => open("about")}
            className="col-span-2 md:col-span-4 row-span-2 group rounded-2xl overflow-hidden relative text-left"
          >
            <img
          ...
          <button
            ...
            className="col-span-4 md:col-span-4 row-span-2 group bg-[#2C3A4D] rounded-2xl p-6 flex flex-col justify-between hover:bg-[#364759] transition-colors text-left"
          >
            <div>
          ...
          {/* Get Involved → GetInvolved panel */}
          <button
            onClick={() => open("get-involved")}
            className="col-span-4 md:col-span-4 row-span-3 group bg-[#E8366A] rounded-2xl p-6 flex flex-col justify-between hover:bg-[#D4215A] transition-colors text-left"
          >
            <div>
          ...
          <div className="col-span-4 md:col-span-4 row-span-1 rounded-2xl overflow-hidden grid grid-cols-2 gap-2">
            <button
              ...
              className="group bg-[#15803d] rounded-2xl px-4 py-3 flex items-center justify-between hover:bg-[#166534] transition-colors text-left"
            >
              <div>
