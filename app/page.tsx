    ...
    <div className="min-h-screen">
      ...
      <section id="get-involved" className="py-24 bg-[#e91e63] text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-12 max-w-2xl mx-auto">Every volunteer, donation, yard sign, and conversation brings us closer to strong, principled leadership in District 1.</p>
          
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a href="#" className="bg-white text-[#e91e63] px-10 py-4 rounded-full text-lg font-semibold hover:bg-gray-100 transition-all">Volunteer</a>
            <a href="#" className="bg-white text-[#e91e63] px-10 py-4 rounded-full text-lg font-semibold hover:bg-gray-100 transition-all">Request Yard Signs</a>
            <a href="#" className="bg-white text-[#e91e63] px-10 py-4 rounded-full text-lg font-semibold hover:bg-gray-100 transition-all">Donate</a>
          </div>
        </div>
      </section>
